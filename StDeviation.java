...
public class StDeviation {
    ...
    private double    sdMidpoint    = INVALID;
    ...
    public void setMin(int userMin){
        ...
        System.out.println("Min"+sdMinRange);
    }
    ...
    public double calcAverage(){
        ...
        switch (getCalcMethod()){
            ...
            case GROUPED:{
                ...
                if(getNumberOfDataItems()%getNumberOfGroups() != 0){

                    System.out.println("ERROR: The number of data items and the number of groups are not evenly divisible");

                }else{

                    sdGroupSize = getNumberOfDataItems()/getNumberOfGroups();

                    sdMin = getMin();

                    sdMax = getMin()+sdGroupSize;

                    for(int j= 0;j<getNumberOfGroups();j++ ) {

                        sdMidpoint = (double)sdMin+(double)sdMax/2;
                        System.out.println(sdMin);
                        System.out.println(sdMax);
                        System.out.println(sdMidpoint);
                        gFrequency = 0;
                        if (getMax()>getMin()) {
                            ...
                            for (int i = sdMin; i <= sdMax; i++) {
                                ...
                                System.out.println("gfrequency");
                                System.out.println(gFrequency);
                            }
                            total = total + (sdMidpoint * gFrequency);
    ...
    public double calcVariance(){
        ...
        System.out.println(getCalcMethod());
